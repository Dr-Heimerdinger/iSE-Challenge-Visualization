...
from components import step1_parse, step1b_verify_io, step1c_generate_api_handler, step2_generate, step3_sandbox
...
def main():
    ...
    step3_sandbox.run(ui_script_path, task_info_with_handler)
